                                ...
                                <div className="flex justify-between items-start">
                                    ...
                                    {status !== 'delivered' && config.next && status !== 'ready' && onUpdateItemStatus && (
                                        <button
                                            ...
                                            className={clsx(
                                                "p-2 rounded-lg transition-all flex flex-col items-center gap-1 min-w-[70px] shadow-sm",
                                    ...
                                    {status === 'ready' && (
                                        <div className="p-2 text-emerald-400 flex flex-col items-center min-w-[70px] bg-emerald-900/20 rounded-lg border border-emerald-500/30">
